...
namespace IdentityV3V4.Identity
{
    /// <summary>
    /// Implements the standard Identity password hashing.
    /// </summary>
    /// <typeparam name="TUser">The type used to represent a user.</typeparam>
    public class V2PasswordHasher<TUser> : IPasswordHasher<TUser> where TUser : class
    {
        /* =======================
        ...
        private static string HashPasswordOriginal(string password)
        {
            if (password == null)
            {
